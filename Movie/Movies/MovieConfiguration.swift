...
class MovieConfigurator {
    ...
    static func configureModule(movieTitle: String, movieYear: String?, movieType: String?, movies: SearchModel, viewController: MovieViewController) {
        ...
        let interactor = MovieInteractorImplementation(movieService: MovieServiceImplementation(), searchService: SearchServiceImplementation(), saveRecent: SaveRecentMovieServiceCoreData())
